...
describe Lumberjack::Logger do
  ...
  context "logging" do
    ...
    it "should add entries with a numeric severity and a message" do
      ...
      output.string.should == "2011-01-30T12:31:56.123 INFO [test(#{Process.pid}) #] test#{n}"
    end
    ...
    it "should add entries with a custom progname and message" do
      ...
      output.string.should == "2011-01-30T12:31:56.123 INFO [app(#{Process.pid}) #] test#{n}"
    end
    ...
    it "should add entries with a local progname and message" do
      ...
      output.string.should == "2011-01-30T12:31:56.123 INFO [block(#{Process.pid}) #] test#{n}"
    end
