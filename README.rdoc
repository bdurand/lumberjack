...
Lumberjack is a simple, powerful, and fast logging implementation in Ruby. It uses the same API as the standard library Logger class and as ActiveSupport::BufferedLogger in Rails.
